        ...
        do{
            ...
            try {
                ...
                switch(respuesta){
                                ...
                                do{
                                    ...
                                    try {
                                        ...
                                        switch(eleccion){
                                            ...
                                            case 4 -> {
                                                //terminamos el for y con eso la corrida del juego antes de tiempo
                        ...
                        if (lectura=='S') {
                            do{
                                ...
                                try {
                                    ...
                                    switch (opción) {
                                        case 1 -> CuerposCelestes.rellenar(estrellas, 0);
                                        case 2 -> CuerposCelestes.rellenar(planetas, 1);
                                        case 3 -> CuerposCelestes.rellenar(nebulosas, 2);
                                        case 4 -> {
                                        }
                                        default -> System.out.println("Esa opción no es valida");
                                    } 
                    ...
                    case 3 -> System.out.println("Saliendo del juego..."); // mensaje de salida para el programa
