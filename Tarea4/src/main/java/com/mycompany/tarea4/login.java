...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Congreso FCC-BUAP");
        ...
        jButton1.setBackground(new java.awt.Color(204, 242, 247));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/EscudoBUAP.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      String Nom, pass;
        ...
        if(Nom.equals("Paris Hilton") && pass.equals("123456")){
            this.setVisible(false);
            Registro reg= new Registro();
            reg.setVisible(true);
        }else{
            JOptionPane.showMessageDialog(this, "El usuario o contraseña es invalido");
        }
