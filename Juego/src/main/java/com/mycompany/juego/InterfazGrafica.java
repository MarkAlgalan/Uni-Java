...
public class InterfazGrafica extends Juego {
 ...
 int numeroNebulosas=7;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            int a= (int) (Math.random()*numeroPlanetas);
            ...
            do{
                r1=(int) (Math.random()*numeroPlanetas);
            }while(r1==a);
                
            do{
                r2=(int) (Math.random()*numeroPlanetas);
            }while(r2==a||r2==r1);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
            ...
            modulo = contadorTurno % 2;
            if (modulo == 1){
                if (seleccionTurnoImpar == 0){
                    seleccionTurno = true;
                    seleccionTurnoImpar = 1;   
                }else{
            ...
            int a= (int) (Math.random()*numeroEstrellas);
            int b= (int) (Math.random()*4);
            ...
            do{
                r1=(int) (Math.random()*numeroEstrellas);
            }while(r1==a);
                
            do{
                r2=(int) (Math.random()*numeroEstrellas);
            }while(r2==a||r2==r1);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
            ...
            int a= (int) (Math.random()*numeroNebulosas);
            ...
            do{
                r1=(int) (Math.random()*numeroNebulosas);
            }while(r1==a);
                
            do{
                r2=(int) (Math.random()*numeroNebulosas);
            }while(r2==a||r2==r1);
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        if (respondioMal1 && respondioMal2){
            respondieronMal = 1;
        }
        if(respondieronMal == 1){
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        if(respondieronMal == 1){
            JOptionPane.showMessageDialog(null, "Los dos respondieron mal la pregunta.");
            JOptionPane.showMessageDialog(null, "La respuesta correcta era " + respuestaCorrectaNebulosa +"!");
